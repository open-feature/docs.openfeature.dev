...
The Evaluation API is the primary component of OpenFeature that _application authors_ interact with. The Evaluation API allows developers to evaluate feature flags to alter control flow and application characteristics. The evluation API
...
| variant (optional\*) | the variant assocaited with the return flag value    |
