...
Before you can start evaluating flags, you must set a [_provider_](./provider). The provider is the translation layer between the evaluation API and the flag system you use.
...
```go
// get a boolean value
boolValue, err := client.BooleanValue("boolFlag", false, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get a string value
stringValue, err := client.StringValue("stringFlag", "default", openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get an integer value
intValue, err := client.IntValue("intFlag", 1, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get a float value
floatValue, err := client.FloatValue("floatFlag", 3.14, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get an object value
objectValue, err := client.ObjectValue("objectFlag", myObject, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})
```
...
| error code (optional)    | an [error code](/docs/specification/types#error-code) that catigorizes flag evaluation errors |
...
```go
// get details of boolean evaluation
boolDetails, err := client.BooleanValueDetails("boolFlag", false, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get details of string evaluation
stringDetails, err := client.StringValueDetails("stringFlag", "default", openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get details of integer evaluation
intDetails, err := client.IntValueDetails("intFlag", 1, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get details of float evaluation
floatDetails, err := client.FloatValueDetails("floatFlag", 3.14, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})

// get details of object evaluation
objectDetails, err := client.ObjectValueDetails("objectFlag", myObject, openfeature.EvaluationContext{}, openfeature.EvaluationOptions{})
```
