...
| error code (optional)    | an [error code](/docs/specification/types#error-code) that categorizes flag evaluation errors |
...
$boolValue = $client.getBooleanDetails("boolFlag", false, null, null);

// get details of a string evaluation
$stringValue = $client.getStringDetails("stringFlag", "default", null, null);

// get details of an integer evaluation
$intValue = $client.getIntegerDetails("intFlag", 1, null, null);

// get details of a float evaluation
$floatValue = $client.getFloatDetails("floatFlag", 0.9, null, null);

// get details of an object evaluation
$objectValue = $client.getObjectDetails("objectFlag", $myObjectInstance, null, null);
```
