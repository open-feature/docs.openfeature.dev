...
[flag-key]: https://docs.openfeature.dev/specification/glossary#flag-key
[error-code]: https://docs.openfeature.dev/specification/types#error-code
...
[flagd-config]: https://github.com/open-feature/flagd/blob/main/docs/configuration/configuration.md
