...
func (f *StoredFlag) Evaluate(evalCtx openfeature.FlattenedContext) (string, string, interface{}, error) {
...
type FeatureProvider interface {
	...
	ObjectEvaluation(flagKey string, defaultValue interface{}, evalCtx FlattenedContext) ResolutionDetail
	Hooks() []Hook
}
```
...
func (p *Provider) resolveFlag(flagKey string, defaultValue interface{}, evalCtx openfeature.FlattenedContext) openfeature.ResolutionDetail {
