...
title: Creating a Hook for the golang-sdk
authors: [skyerus]
tags: [golang, blog, tutorial, golang-sdk, hooks]
unlisted: false
---
...
This tutorial uses the existing [hex regex validator](https://github.com/open-feature/golang-sdk-contrib/hooks/validator/pkg/regex/hex.go).
...
go get github.com/open-feature/golang-sdk-contrib/hooks/validator
```
