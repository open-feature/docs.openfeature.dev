...
title: Configuring a logger for the golang-sdk
authors: [skyerus]
tags: [golang, blog, tutorial, golang-sdk, hooks, logging, logger]
draft: false
---
...
Subject to many opinions and differing principles of best practice, the best thing we could do for the `golang-sdk` was
...
*Configure the popular go logger [zap](https://github.com/uber-go/zap) with the golang-sdk.*
...
c.BooleanValue("bar", false, evalCtx, openfeature.EvaluationOptions{})
```
...
7. (optional) Tweak the level set in step 1 to decrease the verbosity
